...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th colspan="{{ $maiorNumeroDeRegistros + 2 }}">FREQUÊNCIA DO MÊS {{$mes}} DE {{$ano}}</th>
            </tr>
            <tr>
                <th colspan="2">DIA</th>
        ...
        <tbody>
            @foreach ($dias as $dia)
                <tr 
                    @if ($dia['diaDaSemana'] == 7 || $dia['diaDaSemana'] == 6)
                        class="finalDeSemana"
                    @endif
                 >
    ...
    <footer>
        ...
        <div class="assinatura">
            <p>_____________________________</p>
            <p>Visto do Diretor de Serviço</p>
        </div>
        <div class="assinatura">
            <p>_____________________________</p>
            <p>Visto da Diretora da Unidade</p>
        </div>
